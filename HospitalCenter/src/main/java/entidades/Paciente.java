...
public class Paciente implements Serializable {
     ...
     * @param contraseña
     */
    public Paciente(String nombre, String sexo, String fechaNacimiento, String dpi, String telefono, String peso, String tipoSangre, String email, String contraseña) {
        this.nombre = nombre;
        this.sexo = sexo;
        this.fechaNacimiento = fechaNacimiento;
        this.dpi = dpi;
